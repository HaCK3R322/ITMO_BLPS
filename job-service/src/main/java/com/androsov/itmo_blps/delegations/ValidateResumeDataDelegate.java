...
public class ValidateResumeDataDelegate implements JavaDelegate {
    @Override
    public void execute(DelegateExecution execution) throws Exception {
        ...
        try {
            ...
            execution.setVariable("RESUME_VALIDATION_ERROR", ex.getMessage());
            throw new BpmnError("RESUME_VALIDATION_ERROR", ex.getMessage());
        } catch (Exception ex) {
            execution.setVariable("RESUME_VALIDATION_ERROR", "An error occurred while validating the resume.");
            throw new BpmnError("RESUME_VALIDATION_ERROR", "An error occurred while validating the resume.");
        }
    }
