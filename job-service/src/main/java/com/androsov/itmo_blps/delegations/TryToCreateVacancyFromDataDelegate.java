...
public class TryToCreateVacancyFromDataDelegate implements JavaDelegate {
    ...
    public void execute(DelegateExecution execution) throws Exception {
        ...
        try {
            ...
            execution.setVariable("VACANCY_CREATION_ERROR", "An error occurred while creating the vacancy: " + ex.getMessage());
            throw new BpmnError("VACANCY_CREATION_ERROR", "An error occurred while creating the vacancy: " + ex.getMessage());
        }
    }
